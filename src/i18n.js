const texts = {
  ...
  fa: {
    welcome: "<b>🔰 به فروشگاه اعداد بین المللی خوش آمدید 🔰</b>\n\n{name} 👋\n\n<b>گزینه مناسب را از منو انتخاب کنید:</b>",
    choose_lang: "❍ Please choose your language\n❍ দয়া করে আপনার ভাষা নির্বাচন করুন\n❍ لطفاً زبان خود را انتخاب کنید\n❍ الرجاء اختيار لغتك",
  ...
  bn: {
    welcome: "<b>🔰 আন্তর্জাতিক নম্বর স্টোরে স্বাগতম 🔰</b>\n\n{name} 👋\n\n<b>মেনু থেকে উপযুক্ত বিকল্প নির্বাচন করুন:</b>",
    choose_lang: "❍ Please choose your language\n❍ দয়া করে আপনার ভাষা নির্বাচন করুন\n❍ لطفاً زبان خود را انتخاب کنید\n❍ الرجاء اختيار লগتك",
...
const buttons = {
  ...
  bn: {
    ...
    deposit: "💳 ডিপোজিট",
    my_stats: "📊 আমার পরিসংখ্যা",
    notifications: "⚙️ নোটিফিকেশন সেটিংস",
    invite: "🗽 তোমার বন্ধুকে আমন্ত্রন জানান"
  }
};
